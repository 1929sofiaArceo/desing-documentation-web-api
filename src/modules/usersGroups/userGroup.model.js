...
class userGroup {
    ...
    constructor(){
        //set collection
        this.collection = Database.collection('usersGroups');
    }
    ...
    create(body){
        return new Promise((success, reject) =>{
            try{
                ...
                success('userGroup succesfully added');
            }catch(e){
                reject(e)
            }
        })
    ...
    update(idParam, jsonBody){
        return new Promise((success, reject) =>{
            try{
                ...
                success('userGroup with id '+idParam+' was succesfully updated');
            }catch(e){
                reject(e);
            }
        })
    ...
    delete(idParam){
        return new Promise((success, reject) =>{
            try{
                ...
                success('userGroup succesfully deleted!');
            }catch(e){
                reject(e)
            }
        })
